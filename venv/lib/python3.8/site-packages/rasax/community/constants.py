...
DEFAULT_LOCAL_GIT_REPOSITORY_DIRECTORY = ".app/git"
...
ENVIRONMENTS_MANDATORY_KEYS = [RASA_WORKER_ENVIRONMENT, RASA_PRODUCTION_ENVIRONMENT]
...
RASA_CONFIG_MANDATORY_KEYS = ["language"]
