...
PERMISSIONS = {
    ...
    "workspaces": {"view": {"workspaces.list"}, "modify": {"workspaces.create"}},
    ...
    "insights": {
        "view": {"insights.nlu.list", "insights.nlu.get", "insights.config.get"},
        "modify": {
            "insights.nlu.create",
            "insights.nlu.update",
...
DEFAULT_ROLES = {
    ...
    TESTER: ["basic.*", "test_conversation.*", "models.view.*", "insights.view.*"],
}
