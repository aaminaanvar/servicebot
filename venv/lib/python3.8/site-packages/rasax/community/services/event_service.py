...
class EventService(DbService):
    ...
    def get_events_count(self) -> int:
        ...
        """
        return self.cached_query.count(self.query(ConversationEvent))
    ...
    def get_conversation_metadata_for_all_clients(
        ...
        # We first want to get total number of conversations without timestamp filter
        conversations = conversations.filter(query)
        number_conversations = self.cached_query.count(conversations)
        ...
        # Now we apply the timestamp filter as well
        conversations = conversations.filter(query)
    ...
    def get_number_of_conversations(self) -> int:
        ...
        """
        return self.cached_query.count(self.query(Conversation))
