...
class GitService(DbService):
    ...
    def create_branch(self, branch_name: Text) -> None:
        ...
        Raises:
            GitBranchError: If the branch already exists.
        """
        if self._find_branch(branch_name):
            raise rasax.community.services.integrated_version_control.exceptions.GitBranchError(
    ...
    def _commit_to_new_branch(self, branch_name: Text, message: Optional[Text]) -> None:
        ...
        Raises:
            GitBranchError: If the branch cannot be created.
        """
